...
String value = await HttpClientUtil.get("lib/modules/utils/test/resources/restorantlar.json");
...
print(valueJsonMap);
  // List<Restaurant> restaurants = JsonUtil.parseRestaurants(jsonMap['restorantlar']);

  valueJsonMap["restorantlar"].forEach((restaurant) {
